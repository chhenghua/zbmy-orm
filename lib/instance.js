...
Instance.prototype = {
    ...
    findAndCountAll: function(){
        handler.HandlerFactory(this.modelName, 'findAndCountAll', arguments);
    },
    count: function(){
    ...
    w_findAndCountAll: function(){
        handler.HandlerFactory(this.modelName, 'w_findAndCountAll', arguments);
    },
    w_count: function(){
